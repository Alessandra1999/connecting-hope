...
const profiles = [
  {
    ...
    description: 'Aluna do curso Dev Full Stack Jr da +PraTi, cursando o 5º semestre de Análise e Desenvolvimento de Sistemas, apaixonada por gatos e café preto!',
  ...
  },
  {
    picture: Fernanda,
    name: 'Fernanda Akemi',
    description: 'Arquiteta de formação, apaixonada por tecnologia, café e boas visitas a museus. Aluna do curso Dev Full Stack Jr. da +PraTi e cursando Sistemas de Informação.',
  ...
  },
  {
    picture: Gabriel,
    name: 'Gabriel Vitti',
    description: 'Desenvolvedor backend na Petrobrás e engenheiro de automação. Amante de café, pessoas e mangás coreanos :)',
  ...
  },
  {
    ...
    description: 'Desenvolvedor Front-end, apaixonado por puzzles, RPGs de mesa e por uma boa limonada, um dos poucos alunos paulistas do curso Dev Full Stack Jr. da +PraTi.',
  ...
  },
  {
    picture: Israel,
    name: 'Israel Santos',
    description: 'Opa, eu sou o Israel, desenvolvedor Full Stack e apaixonado por programação. No meu tempo livre, gosto de codar por hobby, sempre com uma xícara de café ao lado para acompanhar. ☕',
          ...
          <div className="relative h-full w-full bg-gradient-to-l from-primary-light-350 from-47% to-primary-light-650">
            <div className="absolute inset-0 flex flex-col md:flex-row h-full w-full items-center justify-evenly">
              ...
              <div className="flex flex-col items-center gap-7 lg:mr-14 md:mr-10">
                <h1 className="text-3xl md:text-5xl lg:text-6xl tracking-tighter font-sans font-bold text-primary-light-750">{name}</h1>
                <p className="text-1xl md:text-2xl lg:text-3xl xl:max-w-screen-2xl max-w-80 text-center text-primary-light-750">{description}</p>
        ...
        <div className="relative h-full w-full bg-gradient-to-l from-primary-light-350 from-47% to-primary-light-650">
          <div className="absolute inset-0 flex flex-col md:flex-row h-full w-full items-center justify-evenly">
            <div className="flex flex-col items-center gap-9 mx-7">
              <h1 className="text-3xl md:text-5xl lg:text-6xl tracking-tighter font-sans font-bold text-primary-light-750">Tecnologias Utilizadas</h1>
