...
const items = [
    ...
    },
    {
        ...
        description: "Descreva a sua ONG - essa é a parte onde você contará a sua história.",
    },
    {
        title: "Compartilhe",
        description: "Divulgue em suas redes, todos os dias, e peça que seus amigos e familiares também compartilhem em suas redes e grupos.",
    },
]
...
const reasons = [
    {
        ...
        description: "No Connecting Hope, sua ONG terá acesso a uma rede global de pessoas interessadas em fazer a diferença. A plataforma ajuda a conectar sua causa com voluntários, doadores e parceiros em potencial, ampliando o alcance e o impacto das suas iniciativas sociais."
    },
    {
        icon: Two,
        title: "Facilidade para Mobilizar Recursos",
        description: "Com um sistema intuitivo, você pode criar campanhas de arrecadação e receber apoio financeiro de forma rápida e segura. O Connecting Hope facilita a conexão entre sua ONG e pessoas dispostas a contribuir com doações para fazer sua missão crescer."
    },
    {
        icon: Three,
        title: "Apoio e Conexões Estratégicas",
        description: "Além de visibilidade, o Connecting Hope oferece uma comunidade de outras ONGs, organizações e especialistas, permitindo que você troque experiências, forme parcerias estratégicas e tenha acesso a recursos que fortalecem seu projeto."
    },
    {
        icon: Four,
        title: "Foco em Causas Importantes",
        description: "Se a sua ONG atua em áreas como educação, saúde, meio ambiente ou assistência social, o Connecting Hope tem um público engajado nessas causas. Isso garante que você estará conectado a pessoas que compartilham do mesmo propósito e que realmente querem ajudar."
    },
    {
        icon: Five,
        title: "Impacto Social Real",
        description: "Criar sua ONG no Connecting Hope não é apenas uma formalidade, é uma oportunidade de causar um impacto real na sociedade. Ao conectar sua organização com pessoas e recursos certos, a plataforma acelera o crescimento e a sustentabilidade da sua causa, ajudando você a transformar mais vidas."
    },
    {
        icon: Six,
                ...
                <div>
                    ...
                    <div className="max-w-2xl">
                        <p className="mb-5 text-lg lg:text p-2">
                            Aqui no Connecting Hope, acreditamos que pequenas ações podem gerar grandes mudanças. Desenvolvido por alunos da MaisPraTi, nosso site foi criado para conectar ONGs e doadores de forma simples e acessível, com foco especial nas iniciativas de apoio às comunidades afetadas pelo recente desastre no Rio Grande do Sul. Nossa missão é facilitar o encontro entre quem precisa de ajuda e quem deseja contribuir, promovendo a solidariedade e o impacto positivo. Juntos, podemos transformar vidas e reconstruir o futuro.
                        </p>
