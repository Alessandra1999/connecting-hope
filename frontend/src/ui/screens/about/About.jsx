...
function About() {
  return (
    <div className="min-h-screen flex flex-col w-screen bg-gradient-to-b from-primary-light-250 to-primary-light-400 dark:from-primary-dark-250 dark:to-primary-dark-500">
